 ...
 *      <p>角色名称中可以使用通配符进行模糊匹配。'?' Matches any single character. '*' Matches any sequence of characters (including the empty sequence).</p>
 *      <p>roles中的角色可以配置多个，以英文逗号分隔，为并列关系，即逻辑“或”</p>
 *      <p>本示例表达式代表的含义为：任何[拥有以admin结尾(包括admin)角色]或者[拥有vip角色并且级别为9]或者[拥有vip角色并且级别小于5]的用户，均可通过认证，满足任何一个或多个条件均可</p>
 *  </li>
 *  <li>
